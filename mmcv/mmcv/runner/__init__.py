...
from .checkpoint import (CheckpointLoader, _load_checkpoint,
                         _load_checkpoint_with_prefix, load_checkpoint, load_checkpoint_cococlip,
...
__all__ = [
    ...
    'GradientCumulativeFp16OptimizerHook', 'DefaultRunnerConstructor', 'load_checkpoint_cococlip'
]
