...
# class AnimalPoseDataset(Kpt2dSviewRgbImgTopDownDataset_Part):
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            #For only eval on part of keypoints TODO need to revise back
            # for i in [2,3,7]:
            #     joints_3d[i] = 0
            #     joints_3d_visible[i] = 0
    ...
    def _do_python_keypoint_eval(self, res_file):
        ...
        #             continue
        #     # for j in [2, 3, 7]:
        #         if self.coco.dataset['annotations'][i]['keypoints'][3 * j + 2] < 1.0:
        #             continue
        #         self.coco.dataset['annotations'][i]['keypoints'][3 * j + 2] = 0.0
        #         self.coco.dataset['annotations'][i]['keypoints'][3 * j + 1] = 0.0
        #         self.coco.dataset['annotations'][i]['keypoints'][3 * j] = 0.0
        #         num_mask += 1
        #     self.coco.dataset['annotations'][i]['num_keypoints'] -= num_mask
